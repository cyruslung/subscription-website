...
function Footer() {
    return (
        <footer className="bg-black pt-8 lg:pt-12 relative z-10" >
                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
                        <div className="w-full mb-10">
                            ...
                            <ul>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Home</a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Features</a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">About</a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className=" inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Testimonial</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
                        <div className="w-full mb-10">
                            ...
                            <ul>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">How it works</a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Privacy policy
                                    </a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Terms of Service</a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className="inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2">Refund policy</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div className="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
                        <div className="w-full mb-10">
                            <h4 className="text-white text-lg font-semibold mb-9"> Our Products </h4>
                            <ul>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className=" inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2 " > LineIcons </a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className=" inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2 " > Ecommerce HTML </a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className=" inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2 " > Ayro UI </a>
                                </li>
                                <li>
                                    <a href="#" onClick={ (e) => { e.preventDefault() } } className=" inline-block text-base text-neutral-400 hover:text-violet-700 leading-loose mb-2 " > PlainAdmin </a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section id="contact" className="relative py-8 mt-12 lg:mt-14 border-hr">
                            ...
                            <div className="my-1">
                                <div className=" flex items-center justify-center md:justify-start -mx-3 " >
                                    <Link href="/privacyPolicy" >
                                        <a className="text-neutral-400 hover:text-violet-700 px-3 text-sm"> Privacy Policy </a>
                                    </Link>
                                    <Link href="/legalNotice" >
                                        <a className="text-neutral-400 hover:text-violet-700 px-3 text-sm"> Legal Notice </a>
                                    </Link>
                                    <Link href="/termsOfService" >
                                        <a className="text-neutral-400 hover:text-violet-700 px-3 text-sm"> Terms Of Service </a>
                                    </Link>
                                </div>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3 lg:w-1/2 px-4">
                            <div className="flex justify-center md:justify-end my-1">
                                <p className="text-neutral-400 text-sm">
                                    {new Date().getFullYear()} &copy;Cyrus&reg; Corporation | All Rights Reserved
                                </p>
                            </div>
                        </div>
                    </div>
