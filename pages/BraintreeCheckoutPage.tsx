...
// import BraintreeDropInCredit from "@/components/features/BraintreeDropInCredit";

// import ReactDOM from "react-dom";
// import * as dropin from "braintree-web-drop-in";
// import BraintreeDropIn from "@/components/features/BraintreeDropIn3D";
...
//     const [showBraintreeDropInCredit, setShowBraintreeDropInCredit] = useState(false);
...
//     const loginUrl = host + "member/login"
//     const initTokenUrl = host + "payment/getpaymenttoken";
//     const createOrderUrl = host + "payment/createorder";
//     const createCreditOrder = host + "payment/CreateCreditOrder";

//     useEffect(() => {
//         const jwtToken = 'your_jwt_token';

//         const fetchData = async () => {
//             const response = await axios.get(initTokenUrl, {
//                 headers: {
...
//                 const paymentInitToken = response.data.result;
//                 // Set the client token here
//                 setClientToken(paymentInitToken);
//             }
//     };
...
//     const handleSubmit = () => {
//         // 在這裡處理結帳邏輯，例如顯示 Braintree Drop-in 元件
//         // 調用的API，並將所選訂閱方案發送給後端
//         dispatch(checkout());
//     };
...
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="fname" id="fname" value="addison" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="lname">Last Name:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="lname" id="lname" value="Chang" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="phone">Phone:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="phone" id="phone" value="09999585522" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="ad1">Address1:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="ad1" id="ad1" value="6435 West Villa Linda Dr" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="ad2">Address2:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="ad2" id="ad2" value="" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="city">City:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="city" id="city" value="Olathe" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="state">State:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="state" id="state" value="Banten" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="zcode">Zip Code:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="zcode" id="zcode" value="60543" /><br />

//                                                                     <label className="mb-2 font-bold text-sm text-gray-900 inline-block w-[100px]" htmlFor="country">Country:</label>
//                                                                     <input className="border py-1 px-3 text-sm text-grey-800" type="text" name="country" id="country" value="US" />
//                                                                 </form>
//                                                             </div>
//                                                         )}
//                                                     </div>
...
//                                                                         <div className="mt-4">
//                                                                             <p className="text-sm text-gray-500">
//                                                                                 Order confirmation emails will be sent to the following email address: Rabbyxiao@subscription.com
//                                                                             </p>
//                                                                         </div>
